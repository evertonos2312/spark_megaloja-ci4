<section class="content-main">
    <div class="content-header">
        ...
        <div>
            <a href="{app_url}admin/categorias/core/" class="btn btn-primary"><i class="material-icons md-plus"></i> Criar novo</a>
        </div>
    </div>
    {if ($msg)}
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{app_url}admin/categorias/core/{id}" class="btn btn-light"> <i class="far fa-edit"></i> Editar</a>
                            <input type="hidden" id="{id}">
                            
                            <button id="delete-btn"onclick="categoriasDelete{noparse}({/noparse}'{id}', '{name}'{noparse}){/noparse}" class="btn btn-warning"> <i class="fas fa-trash"></i> Excluir</button>
                        </td>
                    </tr>
                ...
                {else}
                    <h5 class="notfound">Nenhuma categoria encontrada.</h3>
                {endif}
